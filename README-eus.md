...
Software hau Vendy aplikazio-suitearen parte da. **Electron** erabiliz garatu da, eta **Vite** eta **React** teknologiak erabiltzen ditu erabiltzaile interfazea eraikitzeko.  [**Proiektuaren egitura**](https://githubtree.mgks.dev/repo/Wyxemon/Vendy-desktop/main/)
